function Tag(inputId){
	...
	obj.initView=function(){
		...
		appendStr += '<input type="text" class="tagInput form-control col-sm-10" placeholder="多个标签可用逗号：&#39;,&#39;或者&#39;，&#39;分开,输入后按回车\"/><div class="tagList" name="RecommendedConcentration"></div>';
		appendStr+='</div>';
	...
	obj.setValue = function (inputValue) {
	    $("#" + this.id + "_tagcontaine .tagList .tagItem").remove();
	    $("#" + this.id).val("");
	    tagTake.setInputValue(this.id, inputValue);
	}
